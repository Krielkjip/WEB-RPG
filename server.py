...
def get_tile_text(current_tile):
    biome_descriptions = {
        "Taiga Forest": ["Taiga Forest", "You are in a Taiga Forest",
                         ...
                         ["Spruce Trees", "Fir Trees", "Pine Trees", "Snow", "Frozen Lakes"]],
        ...
        "Rainforest": ["Rainforest", "You are in a Rainforest",
                       ...
                       ["Towering Trees", "Vibrant Foliage", "Diverse Wildlife", "Thick Canopy", "Dappled Shadows"]],
        "Grassland": ["Grassland", "You are in the Grasslands",
                      ...
                      ["Bison", "Lions", "Hawks"],
                      ["Rolling Grasses", "Low Shrubs", "Scattered Trees", "Open Skies", "Vastness"]],
        "Mountain": ["Mountain", "You are on a Mountain",
                     ...
                     ["Rocky Slopes", "Snow-Capped Peaks", "Alpine Meadows", "Deep Valleys", "Breathtaking Views"]],
        "Forest": ["Forest", "You are in a Forest",
                   ...
                   ["Deer", "Bears", "Wolves"],
                   ["Deciduous Trees", "Coniferous Trees", "Underbrush", "Sunlight Filtering", "Greenish Hue"]],
        "Volcano": ["Volcano", "You are inside a Volcano",
                    ...
                    ["Steaming Vents", "Rugged Lava Fields", "Eruptions", "Ash", "Hot Ground"]],
        "Desert": ["Desert", "You are in a Desert",
                   ...
                   ["Sand Dunes", "Rocky Outcrops", "Sparse Vegetation", "Intense Sunlight", "High Temperatures"]],
        "Ocean": ["Ocean", "You are in a Ocean",
                  ...
                  ["Open Water", "Waves", "Rocky Cliffs", "Sandy Shores", "Marine Life"]],
        "Temperate Forest": ["Temperate Forest", "You are in a Temperate Forest",
                             ...
                             ["Deciduous Trees", "Evergreen Trees", "Carpet of Fallen Leaves",
                              "Seasonal Foliage Changes", "Moderate Climate"]],
        "Tundra": ["Tundra", "You are in a Tundra",
                   ...
                   ["Low-Lying Vegetation", "Mosses", "Lichens", "Hardy Grasses", "Permafrost"]],
        "Savanna": ["Savanna", "You are in a Savanna",
                    ...
                    ["Open Grasslands", "Scattered Trees", "Seasonal Rainfall", "Rocky Outcrops", "Grazing Herds"]]
    }
